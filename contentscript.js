...
// Copy button HTML template for subtitle rows
const COPY_BUTTON_HTML = `
  <span class="subtitle-button-separator"></span>
  <button type="button" aria-label="Copy Finnish text" class="subtitle-copy-button">
...
function addContentToDisplayedSubtitlesWrapper(
  ...
  finnishSubtitleRowElement.style.display = "flex";
  ...
  finnishSubtitleRowElement.insertAdjacentHTML("beforeend", COPY_BUTTON_HTML);

  const copyFinnishButton = finnishSubtitleRowElement.querySelector(".subtitle-copy-button");
