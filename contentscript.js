    ...
    <div class="dual-sub-extension-section">
      ...
      <div style="position: relative; display: inline-block;">
        ...
        <div class="hidden" style="
          ...
          z-index: 10;
        ">
          <a href="#" style="display:block; padding:8px 16px; text-decoration:none; color:#333;">Option 1</a>
          <a href="#" style="display:block; padding:8px 16px; text-decoration:none; color:#333;">Option 2</a>
          <a href="#" style="display:block; padding:8px 16px; text-decoration:none; color:#333;">Option 3</a>
        </div>
      </div>
